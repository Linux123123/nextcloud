...
then
    if ! curl -sfL https://raw.githubusercontent.com/Linux123123/nextcloud/master/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/Linux123123/nextcloud/master/lib.sh -o /var/scripts/lib.sh
fi
